// C1.5b-1 — Renderizador de tiles interiores.
// Cada tile interior se dibuja con estilo pixel-art medieval.
// Exporta dTileI(tile, x, y) para usarse desde drawMap().
  ...
  switch (tile) {
    ...
    case 41: {
      ...
      for (let r = 0; r < 4; r++) {
        for (let c = 0; c < 4; c++) {
          const off = r % 2 === 0 ? 0 : 4;
          cx.fillStyle = ((r + c) % 2 === 0) ? '#6A6458' : '#5E584C';
    ...
    case 54: {
      ...
      cx.fillRect(x + 2, y + 10, 28, 2);
      cx.fillRect(x + 2, y + 20, 28, 2);
      // pergaminos enrollados con sello dorado
      for (let i = 0; i < 3; i++) {
        const dy = 3 + i * 11;
        cx.fillStyle = '#F0E8D0';
    ...
    case 55: {
      ...
      // criaturas miniatura (óvalos de colores)
      const colors = ['#E84040', '#4080E8', '#40B840', '#E8C840', '#D060E0'];
      [
        [10, 9], [20, 9], [10, 19], [20, 19]
      ].forEach(([cx2, cy2], i) => {
